...
for k = 1 : nT
    ...
    [fval2, dfval2,~] = GlikSTEPreConSTE52(learnInfo, learnInfo.hyp, mFORGLIK, lFORGLIK, CGErrorTol, HVAL, M, rangeOfI, @BasicNyst)
    runtimes(1,k) = toc;
    ...
    learnInfo.hyp = [1, 1, 1, 1, 0.5, 1, 1];
    [fval, dfval,~] = GlikSTEPreConSTE52(learnInfo, learnInfo.hyp, mFORGLIK, lFORGLIK, CGErrorTol, HVAL, M, rangeOfI, @BasicNyst);
    
    Glik_hyp = @(hyp)GlikSTEPreConSTE52(learnInfo, hyp, mFORGLIK, lFORGLIK, CGErrorTol, HVAL, M, rangeOfI, @BasicNyst);
    ...
    [~, PreConInvRaw] = BasicNyst(learnInfo, LForDecomp, M, rangeOfI, jitter, KE, KA, sigma);
