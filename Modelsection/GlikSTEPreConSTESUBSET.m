function [fval, dfval,learnInfo] = GlikSTEPreConSTESUBSET(learnInfo, hyp, m, l, CGErrorTol, DerivHVal, M, rangeOfI)
...
newSub = zeros(1,2*Nsub);
for i = 1 : Nsub
    first = 2 * sub(i) - 1;
    newSub(1,2*i-1) = first;
    newSub(1,2*i) = first + 1;
end
