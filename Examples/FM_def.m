...
sysInfo.mu0             = @() FM_init_config(-0.8, 0.8, 0, 0, sysInfo.d, sysInfo.N,1);  %Used to be .5 not .8
...
% Observations
obsInfo.L               = 3;
obsInfo.M               = 30;                      %used to be 2                                                % # trajectories with random initial conditions for learning interaction kernel
...
obsInfo.obs_noise       = 0.001; %used to be .1
