...
function visualize_trajs_1D_NS(sysInfo,obsInfo,solverInfo, learnInfo, phi_est)
...
IC=data(:,1,1);
result               = construct_and_compute_traj_NS(sysInfo,obsInfo,solverInfo,learnInfo, phi_est, IC);
