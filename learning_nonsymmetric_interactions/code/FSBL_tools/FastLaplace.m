function [weights,used,loglik,sigma2,errbars,basis,selected,deleted,alpha,lambda] = FastLaplace(PHI,y,sigma2,eta,lambda_init,sparsity,adaptive,optimal,scale, verbose)
...
if verbose, fprintf(1,'FastLaplace Algorithm converged, # iterations : %d \n',count); end
