%% this code is to visualize the trajectories 


function visualize_trajs_2D_realdata(sysInfo, xpath,traj_hat)
...
%X_coords2                        = cell(length(trajs), sysInfo.d);
